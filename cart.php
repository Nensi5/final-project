...
<div class="row">
    <div class="col-md-12">
           ...
           <thead>
            ...
            <tbody>
                ...
                <tr class="border-top border-bottom">
                    <td><button class="btn btn-danger btn-sm" id="emptyCart">Isprazni korpu</button></td>
                    <td></td>
                    <td>
                        <strong>
                            <?php 
                                echo ($itemCounter==1)?$itemCounter.' proizvod':$itemCounter.' proizvoda'; ?>
                        </strong>
                    </td>
        ...
        <div class="row">
            <div class="col-md-11">
				<a href="checkout.php">
					<button class="btn btn-dark btn-lg float-right">Nastavi dalje</button>
				</a>
            </div>
        </div>
