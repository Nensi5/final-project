            ...
            <div class="row mt-3">
                <div class="col-md-12">
                    <div class="alert alert-success alert-dismissible">
                        ...
                        <img src="<?php echo $imgUrl ?>" class="rounded img-thumbnail mr-2" style="width:40px;"><?php echo $getProductData['product_name']?> Dodato je u korpu. <a href="cart.php" class="alert-link">Pogledaj korpu</a>
                    </div>
                </div>
            </div>
         <?php }?>
            ...
            <div class="col-md-7">
                ...
                <form class="form-inline" method="POST">
                    ...
                    <div class="form-group mb-2 ml-2">
                        <button type="submit" class="btn btn-dark" name="add_to_cart" value="add to cart">Dodaj u korpu</button>
                    </div>
                </form>
